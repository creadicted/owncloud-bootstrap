...
<div id="controls">
	...
	<?php if ($_['isCreatable']):?>
		...
		<div class="btn-toolbar" style="margin: 0;">
					<!--	
			<div id="bcnew" class="btn-group button">
			    ...
			    <ul class="dropdown-menu">
			    	<li data-type='file'>
			    		<a href="#"><?php p($l->t('Text file'));?></a>
					</li>
					<li data-type='folder'>
						<a href="#"><?php p($l->t('Folder'));?></a>
					</li>
					<li data-type='web'>
						<a href="#"><?php p($l->t('From link'));?></a>
					</li>
			    </ul> 
		    </div>
		   -->
			...
			<div class="btn-group input-append">
				...
				<div id="upload" class="button" title="<?php p($l->t('Upload') . ' max. '.$_['uploadMaxHumanFilesize']) ?>">
					<form data-upload-id='1' id="data-upload-form" class="file_upload_form"
						...
						<input class="btn" type="file" id="file_upload_start" name='files[]' />
						<a href="#" class="btn"> <i class="icon-upload"></i> 	<?php p($l->t('Upload')) ?> </a> 
					</form>
				</div>
	  	  	</div>
			...
			<div id="uploadprogresswrapper">
				...
				<input type="button" class="stop" style="display:none" value="<?php p($l->t('Cancel upload'));?>" />
			</div>
...
<div id="editor"></div>
<div  class="alert" id="uploadsize-message" title="<?php p($l->t('Upload too large'))?>">
	<p> <i class="icon-warning-sign"></i>
	<?php p($l->t('The files you are trying to upload exceed the maximum size for file uploads on this server.'));?>
	</p>
</div>
<div id="scanning-message" class="alert alert-info">
	<h3>
